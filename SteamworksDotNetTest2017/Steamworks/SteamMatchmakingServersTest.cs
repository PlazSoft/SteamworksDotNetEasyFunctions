...
//        Console.WriteLine("m_ServerListRequest: " + m_ServerListRequest);
//        Console.WriteLine("m_ServerQuery: " + m_ServerQuery);
//        GUILayout.EndArea();
...
//        Console.WriteLine("SteamMatchmakingServers.IsRefreshing(m_ServerListRequest) : " + SteamMatchmakingServers.IsRefreshing(m_ServerListRequest));

//        Console.WriteLine("SteamMatchmakingServers.GetServerCount(m_ServerListRequest) : " + SteamMatchmakingServers.GetServerCount(m_ServerListRequest));
